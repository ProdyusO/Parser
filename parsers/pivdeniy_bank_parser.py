...
class PivdeniyBankParser(Bank):
    ...
    def get_currency_rate(self):
        ...
        contents = soup.find_all('div', {'class': 'exchangeRates__wrapper'})
        for line in contents:
            name = line.find('div', {'class': 'exchangeRates__row'}).find('p').text.split()[1]
...
if __name__ == '__main__':
    ...
    db.close()
    parser = PivdeniyBankParser(currencies, bank_url, bank_id)
